...
Some packages are not available on R. These are commonly available to install via GitHub, but occasionally require a local installation.
...
This will download and install the package directly from GitHub, and may prompt you to update old packages already installed.

### Non-GitHub, Non-CRAN packages
