...
If you are participating in an intership with the Biometry Hub, you may require additional packages installed, such as ASMap and wgaim.
...
Advice on further packages to install will be provided by your supervisor, but in most cases they can be installed using the same method as above.
